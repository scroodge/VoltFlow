...
/** Official new Belarusian ruble (BYN) graphic symbol, approved by the
 * National Bank of the Republic of Belarus on 2026-01-27. Not yet a Unicode
 * character (submitted for encoding 2026-04-13) — rendered as an inline icon
 * instead of text until real codepoint + font support exist. */
export function BynSymbol(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
