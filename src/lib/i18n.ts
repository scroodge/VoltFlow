...
export const dictionaries = {
  en: {
    ...
    telegram: {
      ...
      openApp: "Back To Voltflow",
      openFullApp: "Back To Voltflow",
      or: "or",
    ...
    dashboard: {
      ...
      chargingTimeLeft: "Time left",
      chargingCharged: "Charged",
      ...
      walkToCarLive: "Last seen {value}",
      walkToCarLastTrip: "From last trip, {value}",
      ...
      priceHelp:
        "Mirrors your utility statement — uses grid energy from the charger.",
      manualProvider: "Provider",
      manualTariffType: "Tariff type",
      manualTariffAuto: "Auto by power/location",
      manualTariffHome: "Home",
      manualTariffCommercialAc: "Commercial AC",
      manualTariffFastDc: "Fast DC",
      manualTariffAutoHelp: "Auto rule: AC 4.0–9.99 kW, fast DC 10.0+ kW.",
      starting: "Starting...",
    ...
    charging: {
      ...
      elapsed: "Elapsed",
      remaining: "Remaining",
      energyFromCharger: "From charger",
      energyFromChargerEstimate: "From charger (est.)",
      energyToBatteryEstimate: "To battery (est.)",
      ...
      tariff: {
        ...
        provider: "Provider",
        type: "Tariff type",
        pricePerKwh: "Price per kWh ({currency})",
        save: "Save tariff",
      ...
      correction: {
        ...
        derivedPrice: "≈ {currency}{price} per kWh",
      ...
      manualEntry: {
        ...
        hint: "For a charge the app did not record. Enter what the provider billed — energy and cost come straight from your receipt.",
        startTime: "Started",
        endTime: "Ended",
        billedKwh: "Billed kWh",
        totalPaid: "Total paid ({currency})",
        preview: "≈ {currency}{price} per kWh · ≈ {power} kW · +{soc}% charge",
        previewUnanchored: "≈ {currency}{price} per kWh · ≈ {power} kW",
        submit: "Add",
        cancel: "Cancel",
        ...
        deleteConfirm: "Delete this manually added session?",
        deleted: "Session deleted",
        errors: {
          invalid_times: "The end time must be after the start time",
          duration_too_long: "A single session cannot be longer than 24 hours",
    ...
    vehicle: {
      ...
      trips: {
        ...
        energyPerKm: "Energy per km",
        netConsumption: "Net consumption after regen",
        points: "Points",
      ...
      analytics: {
        ...
        sohLatestReading: "Latest reading: {date}",
        sohSinglePoint: "One SOH reading is available for this period.",
        ...
        batteryHealthStatusGood: "Good",
        batteryHealthStatusWatch: "Watch",
        batteryHealthStatusPoor: "Poor",
        batteryHealthStatusInsufficientData: "Insufficient data",
        batteryHealthTrendImproving: "Improving",
        batteryHealthTrendStable: "Stable",
    ...
    settings: {
      ...
      push: {
        ...
        localBtn: "Local test",
        serverBtn: "Server test",
        sendingBtn: "Sending...",
        refreshed: "Push status refreshed",
        syncError: "Could not sync push",
        localRequested: "Local notification requested",
        localError: "Could not show local notification",
        serverSent: "Server push sent to {count} device(s)",
        serverError: "Could not send server push",
      },
      clusterBg: {
        title: "Cluster backgrounds",
        help: "Upload 1280×480-friendly images for VoltFlow Dashboard on your BYD cluster.",
        uploadLabel: "Upload PNG or JPG (max 5 MB)",
        refresh: "Refresh",
      ...
      adminCms: {
        ...
        description:
          "Manage articles, questions, accessories, spare parts, and sections for the VoltFlow Telegram knowledge base.",
        open: "Open CMS",
      },
      adminPremium: {
        title: "Premium users",
        description:
          "Manually manage premium status, expiry, user activity, and VoltFlow Mate versions.",
        open: "Open Premium Admin",
      },
      noKeyYet: "No key generated yet",
      toasts: {
        saveLocationError: "Could not save location tariff",
        locationRemoved: "Location tariff removed",
        devSignOutDisabled: "Dev preview — sign out disabled",
        signInForKey: "Sign in before generating a VoltFlow Mate key",
        keyGenerated: "VoltFlow Mate API key generated",
        keyCopied: "VoltFlow Mate API key copied",
        copyKeyError: "Could not copy API key",
        signInForLink: "Sign in before linking VoltFlow Mate",
      },
      cloud: {
        name: "VoltFlow Mate",
        description:
      ...
      pressureUnit: {
        ...
        help: "The car reports pressure in kPa. VoltFlow converts only this display.",
        saved: "Tyre-pressure unit saved.",
        units: {
          kPa: "kPa",
          psi: "psi",
          bar: "bar",
      ...
      providerTariffs: {
        ...
        addProviderDc: "DC price",
        addProviderSave: "Add",
        added: "Provider added",
        deleteConfirm: "Remove “{label}”? This cannot be undone.",
        deleted: "Provider removed",
        cancelSelection: "Cancel",
        deleteSelected: "Delete",
        providerNameRequired: "Provider name is required",
        providerNameExists: "A provider with this name already exists",
      },
  ...
  be: {
    ...
    telegram: {
      ...
      openApp: "Адкрыць Voltflow",
      openFullApp: "Адкрыць Voltflow",
      or: "або",
    ...
    dashboard: {
      ...
      chargingTimeLeft: "Засталося",
      chargingCharged: "Зараджана",
      ...
      walkToCarLive: "Апошні раз на сувязі {value}",
      walkToCarLastTrip: "З апошняй паездкі, {value}",
      ...
      priceHelp:
        "Як у рахунку за электрычнасць — выкарыстоўваецца энергія з сеткі праз зарадную станцыю.",
      manualProvider: "Правайдар",
      manualTariffType: "Тып тарыфу",
      manualTariffAuto: "Аўта па магутнасці/лакацыі",
    ...
    charging: {
      ...
      elapsed: "Прайшло",
      remaining: "Засталося",
      energyFromCharger: "З сеткі",
      energyFromChargerEstimate: "З сеткі (ацэнка)",
      energyToBatteryEstimate: "У батарэю (ацэнка)",
      ...
      tariff: {
        ...
        provider: "Правайдар",
        type: "Тып тарыфу",
        pricePerKwh: "Цана за кВт·г ({currency})",
        save: "Захаваць тарыф",
      ...
      correction: {
        ...
        derivedPrice: "≈ {currency}{price} за кВт·г",
      ...
      manualEntry: {
        ...
        title: "Дадаць прапушчаную зарадку",
        hint: "Для зарадкі, якую праграма не запісала. Увядзіце тое, што выставіў правайдар — энергія і кошт бяруцца проста з чэка.",
        startTime: "Пачатак",
        endTime: "Канец",
        billedKwh: "Аплачана кВт·г",
        totalPaid: "Заплачана ўсяго ({currency})",
        ...
        submit: "Дадаць",
        cancel: "Скасаваць",
        added: "Сесія зарадкі дададзена",
        addedUnanchored:
          "Сесія дададзена — тэлеметрыі побач няма, таму ўзровень зараду невядомы",
        badge: "Уручную",
        socGain: "Дададзена зараду",
        socUnknown: "Узровень зараду невядомы",
        delete: "Выдаліць сесію",
        deleteConfirm: "Выдаліць гэтую ўручную дададзеную сесію?",
        deleted: "Сесія выдалена",
        errors: {
          invalid_times: "Час заканчэння павінен быць пазней за пачатак",
          duration_too_long: "Адна сесія не можа доўжыцца больш за 24 гадзіны",
          invalid_energy: "Увядзіце аплачаныя кВт·г",
          invalid_cost: "Увядзіце суму аплаты",
          invalid_car: "Для гэтага аўто не зададзена ёмістасць батарэі",
          implausible_power:
            "Такія лічбы азначаюць немагчыма павольную зарадку — праверце час",
          overlap: "Сесія зарадкі ўжо ахоплівае гэты прамежак часу",
          future: "Сесія не можа быць у будучыні",
        },
      },
    },
    cars: {
    ...
    vehicle: {
      ...
      trips: {
        ...
        traction: "Цяга",
        consumption: "Выдатак",
        energyPerKm: "Энергія на км",
        netConsumption: "Чысты расход пасля рэкуп.",
        points: "Кропкі",
      ...
      analytics: {
        ...
        summary: {
          ...
          distance: "Прабег",
          regen: "Рэкуп.",
          tripEnergy: "Энергія паездак",
          consumption: "Расход аўто",
          maxSpeed: "V макс.",
          socSwing: "Δ SOC",
          telemetry: "Выбіркі",
        },
        ...
        batteryHealthTitle: "Здароўе батарэі",
        batteryHealthSubtitle:
        ...
        batteryHealthStatusGood: "Добра",
        batteryHealthStatusWatch: "Назіраць",
        batteryHealthStatusPoor: "Дрэнна",
        batteryHealthStatusInsufficientData: "Недастаткова дадзеных",
        batteryHealthTrendImproving: "Паляпшаецца",
        batteryHealthTrendStable: "Стабільна",
    ...
    settings: {
      ...
      push: {
        ...
        no: "не",
        checking: "праверка",
        savedOnDevice: "захавана на прыладзе",
        missing: "адсутнічае",
        none: "няма",
        checkBtn: "Праверыць push",
        checkingBtn: "Праверка...",
        localBtn: "Лакальны тэст",
        serverBtn: "Серверны тэст",
        sendingBtn: "Адпраўка...",
        refreshed: "Статус push абноўлены",
        syncError: "Не ўдалося сінхранізаваць push",
        localRequested: "Лакальнае апавяшчэнне запытана",
        localError: "Не ўдалося паказаць лакальнае апавяшчэнне",
        serverSent: "Серверны push адпраўлены на {count} прыладу(ы)",
        serverError: "Не ўдалося адправіць серверны push",
      },
      clusterBg: {
        title: "Фоны прыборнай панэлі",
        help: "Загрузіце выявы 1280×480 для VoltFlow Dashboard на вашай прыборнай панэлі BYD.",
        uploadLabel: "Загрузіце PNG або JPG (макс. 5 МБ)",
        refresh: "Абнавіць",
        loadError: "Не ўдалося загрузіць фоны",
        uploadError: "Не ўдалося загрузіць",
      },
      adminCms: {
        title: "CMS базы ведаў",
        description:
          "Кіраванне артыкуламі, пытаннямі, аксэсуарамі, запчасткамі і раздзеламі для Telegram-базы ведаў VoltFlow.",
        open: "Адкрыць CMS",
      },
      adminPremium: {
        title: "Premium карыстальнікі",
        description:
          "Ручное кіраванне premium-статусам, тэрмінам дзеяння, актыўнасцю карыстальніка і версіямі VoltFlow Mate.",
        open: "Адкрыць Premium Admin",
      },
      noKeyYet: "Ключ яшчэ не згенераваны",
      toasts: {
        saveLocationError: "Не ўдалося захаваць тарыф месца",
        locationRemoved: "Тарыф месца выдалены",
        devSignOutDisabled: "Dev preview — выхад адключаны",
        signInForKey: "Увайдзіце перад генерацыяй ключа VoltFlow Mate",
        keyGenerated: "API-ключ VoltFlow Mate згенераваны",
        keyCopied: "API-ключ VoltFlow Mate скапіяваны",
        copyKeyError: "Не ўдалося скапіяваць API-ключ",
        signInForLink: "Увайдзіце перад падлучэннем VoltFlow Mate",
      },
      cloud: {
        name: "VoltFlow Mate",
        description:
      ...
      pressureUnit: {
        title: "Ціск у шынах",
        displayUnit: "Адзінка адлюстравання",
        help: "Аўто перадае ціск у kPa. VoltFlow пераўтварае толькі гэты паказ.",
        saved: "Адзінка ціску ў шынах захавана.",
        units: {
          kPa: "kPa",
          psi: "psi",
          bar: "bar",
      ...
      tariffSaving: "Захаванне…",
      tariffSavedShort: "Захавана",
      ...
      providerTariffs: {
        acLabel: "AC",
        dcLabel: "DC",
        save: "Захаваць тарыфы правайдараў",
        ...
        addProviderDc: "Цана DC",
        addProviderSave: "Дадаць",
        added: "Правайдар дададзены",
        deleteConfirm: "Выдаліць “{label}”? Гэта нельга адмяніць.",
        deleted: "Правайдар выдалены",
        cancelSelection: "Скасаваць",
        deleteSelected: "Выдаліць",
        providerNameRequired: "Патрабуецца назва правайдара",
        providerNameExists: "Правайдар з такой назвай ужо існуе",
      },
  ...
  ru: {
    ...
    telegram: {
      ...
      openApp: "Открыть Voltflow",
      openFullApp: "ОткрытьVoltflow",
      or: "или",
    ...
    dashboard: {
      ...
      chargingTimeLeft: "Осталось",
      chargingCharged: "Заряжено",
      ...
      walkToCarLive: "Последний раз на связи {value}",
      walkToCarLastTrip: "С последней поездки, {value}",
      ...
      priceHelp:
        "Как в счете за электричество — используется энергия из сети через зарядную станцию.",
      manualProvider: "Провайдер",
      manualTariffType: "Тип тарифа",
      manualTariffAuto: "Авто по мощности/локации",
      manualTariffHome: "Дом",
    ...
    charging: {
      ...
      elapsed: "Прошло",
      remaining: "Осталось",
      energyFromCharger: "Из сети",
      energyFromChargerEstimate: "Из сети (оценка)",
      energyToBatteryEstimate: "В батарею (оценка)",
      ...
      tariff: {
        ...
        provider: "Провайдер",
        type: "Тип тарифа",
        pricePerKwh: "Цена за кВт·ч ({currency})",
      ...
      correction: {
        ...
        derivedPrice: "≈ {currency}{price} за кВт·ч",
      ...
      manualEntry: {
        ...
        title: "Добавить пропущенную зарядку",
        hint: "Для зарядки, которую приложение не записало. Введите то, что выставил провайдер — энергия и стоимость берутся прямо из чека.",
        startTime: "Начало",
        endTime: "Конец",
        billedKwh: "Оплачено кВт·ч",
        totalPaid: "Заплачено всего ({currency})",
        ...
        submit: "Добавить",
        cancel: "Отмена",
        added: "Сессия зарядки добавлена",
        addedUnanchored:
          "Сессия добавлена — телеметрии рядом нет, поэтому уровень заряда неизвестен",
        badge: "Вручную",
        socGain: "Добавлено заряда",
        socUnknown: "Уровень заряда неизвестен",
        delete: "Удалить сессию",
        deleteConfirm: "Удалить эту добавленную вручную сессию?",
        deleted: "Сессия удалена",
        errors: {
          invalid_times: "Время окончания должно быть позже начала",
          duration_too_long: "Одна сессия не может длиться дольше 24 часов",
          invalid_energy: "Введите оплаченные кВт·ч",
          invalid_cost: "Введите сумму оплаты",
          invalid_car: "Для этого авто не задана емкость батареи",
          implausible_power:
            "Такие цифры означают невозможно медленную зарядку — проверьте время",
          overlap: "Сессия зарядки уже покрывает этот промежуток времени",
          future: "Сессия не может быть в будущем",
        },
      },
    },
    cars: {
    ...
    vehicle: {
      ...
      trips: {
        ...
        traction: "Потрачено",
        consumption: "Расход",
        energyPerKm: "Энергия на км",
        netConsumption: "Чистый расход после рекуп.",
        points: "Точки",
      ...
      analytics: {
        ...
        summary: {
          ...
          distance: "Пробег",
          regen: "Рекуп.",
          tripEnergy: "Энергия поездок",
          consumption: "Расход авто",
          maxSpeed: "V макс.",
          socSwing: "Δ SOC",
          telemetry: "Выборки",
        },
        ...
        sohLatestReading: "Последнее измерение: {date}",
        sohSinglePoint: "За этот период доступно одно измерение SOH.",
        ...
        batteryHealthTitle: "Здоровье батареи",
        batteryHealthSubtitle:
        ...
        batteryHealthStatusGood: "Хорошо",
        batteryHealthStatusWatch: "Наблюдать",
        batteryHealthStatusPoor: "Плохо",
        batteryHealthStatusInsufficientData: "Недостаточно данных",
        batteryHealthTrendImproving: "Улучшается",
        batteryHealthTrendStable: "Стабильно",
        ...
        aux12vChange: "Изменение",
        aux12vVoltage: "Напряжение",
        aux12vMin: "Минимум",
    ...
    settings: {
      ...
      push: {
        ...
        no: "нет",
        checking: "проверка",
        savedOnDevice: "сохранена на устройстве",
        missing: "отсутствует",
        none: "нет",
        checkBtn: "Проверить push",
        checkingBtn: "Проверка...",
        localBtn: "Локальный тест",
        serverBtn: "Серверный тест",
        sendingBtn: "Отправка...",
        refreshed: "Статус push обновлён",
        syncError: "Не удалось синхронизировать push",
        localRequested: "Локальное уведомление запрошено",
        localError: "Не удалось показать локальное уведомление",
        serverSent: "Серверный push отправлен на {count} устройство(а)",
        serverError: "Не удалось отправить серверный push",
      },
      clusterBg: {
        title: "Фоны приборной панели",
        help: "Загрузите изображения 1280×480 для VoltFlow Dashboard на вашей приборной панели BYD.",
        uploadLabel: "Загрузите PNG или JPG (макс. 5 МБ)",
        refresh: "Обновить",
        loadError: "Не удалось загрузить фоны",
        uploadError: "Не удалось загрузить",
      },
      adminCms: {
        title: "CMS базы знаний",
        description:
          "Управление статьями, вопросами, аксессуарами, запчастями и разделами для Telegram-базы знаний VoltFlow.",
        open: "Открыть CMS",
      },
      adminPremium: {
        title: "Premium пользователи",
        description:
          "Ручное управление premium-статусом, сроком действия, активностью пользователя и версиями VoltFlow Mate.",
        open: "Открыть Premium Admin",
      },
      noKeyYet: "Ключ ещё не сгенерирован",
      toasts: {
        saveLocationError: "Не удалось сохранить тариф места",
        locationRemoved: "Тариф места удалён",
        devSignOutDisabled: "Dev preview — выход отключён",
        signInForKey: "Войдите перед генерацией ключа VoltFlow Mate",
        keyGenerated: "API-ключ VoltFlow Mate сгенерирован",
        keyCopied: "API-ключ VoltFlow Mate скопирован",
        copyKeyError: "Не удалось скопировать API-ключ",
        signInForLink: "Войдите перед подключением VoltFlow Mate",
      },
      cloud: {
        name: "VoltFlow Mate",
        description:
      ...
      pressureUnit: {
        ...
        help: "Автомобиль передаёт давление в kPa. VoltFlow преобразует только этот показ.",
        saved: "Единица давления в шинах сохранена.",
        units: {
          kPa: "kPa",
          psi: "psi",
          bar: "bar",
      ...
      tariffSaving: "Сохранение…",
      tariffSavedShort: "Сохранено",
      ...
      providerTariffs: {
        acLabel: "AC",
        dcLabel: "DC",
        save: "Сохранить тарифы провайдеров",
        ...
        addProviderDc: "Цена DC",
        addProviderSave: "Добавить",
        added: "Провайдер добавлен",
        deleteConfirm: "Удалить “{label}”? Это нельзя отменить.",
        deleted: "Провайдер удалён",
        cancelSelection: "Отмена",
        deleteSelected: "Удалить",
        providerNameRequired: "Укажите название провайдера",
        providerNameExists: "Провайдер с таким названием уже существует",
      },
