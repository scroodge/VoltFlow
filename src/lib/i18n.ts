  ...
  en: {
    ...
    vehicle: {
      ...
      analytics: {
        ...
        cellDeltaSubtitle:
          "Max cell delta at the end of each charge. Partial charges let it grow; charges to 100% bring it back down.",
        cellDeltaNoData:
          "No end-of-charge delta captured yet. It appears here after your next completed charge.",
        cellDeltaLatest: "Latest",
        cellDeltaFullCharge: "To 100%",
        cellDeltaPartialCharge: "Partial charge",
        cellDeltaAtSoc: "at {value}% SOC",
        cellDeltaSoh: "SOH {value}%",
  ...
  be: {
    ...
    vehicle: {
      ...
      analytics: {
        ...
        cellDeltaSubtitle:
          "Максімальная дэльта ячэек у канцы кожнай зарадкі. Ад няпоўных зарадак яна расце, зарадкі да 100% яе зніжаюць.",
        cellDeltaNoData:
          "Дэльта ў канцы зарадкі яшчэ не зафіксавана. З'явіцца тут пасля наступнай завершанай зарадкі.",
        cellDeltaLatest: "Апошняя",
        cellDeltaFullCharge: "Да 100%",
        cellDeltaPartialCharge: "Няпоўная зарадка",
        cellDeltaAtSoc: "пры {value}% SOC",
        cellDeltaSoh: "SOH {value}%",
  ...
  ru: {
    ...
    vehicle: {
      ...
      analytics: {
        ...
        cellDeltaSubtitle:
          "Максимальная дельта ячеек в конце каждой зарядки. От недозарядов она растёт, зарядки до 100% её снижают.",
        cellDeltaNoData:
          "Дельта в конце зарядки ещё не зафиксирована. Появится здесь после следующей завершённой зарядки.",
        cellDeltaLatest: "Последняя",
        cellDeltaFullCharge: "До 100%",
        cellDeltaPartialCharge: "Недозаряд",
        cellDeltaAtSoc: "при {value}% SOC",
        cellDeltaSoh: "SOH {value}%",
