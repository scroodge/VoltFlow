  ...
  en: {
    ...
    settings: {
      ...
      locationTariffs: {
        ...
        presetAppliedHint: "Preset applied — press “Store default” to save it.",
  ...
  be: {
    ...
    settings: {
      ...
      locationTariffs: {
        ...
        presetAppliedHint: "Прэсет ужыты — націсніце «Захаваць», каб захаваць тарыфы.",
  ...
  ru: {
    ...
    settings: {
      ...
      locationTariffs: {
        ...
        presetAppliedHint: "Пресет применён — нажмите «Сохранить», чтобы сохранить тарифы.",
