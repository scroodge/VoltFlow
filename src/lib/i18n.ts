...
export const dictionaries = {
  en: {
    ...
    settings: {
      ...
      providerTariffs: {
        ...
        body: "Edit AC/DC prices per provider — sessions at a saved location bill at these rates automatically.",
        acLabel: "AC",
        dcLabel: "DC",
        save: "Save provider tariffs",
        saved: "Provider tariffs saved",
        resetDone: "Reset to default price",
        invalidPrice: "Prices must be zero or positive",
        userProvidersTitle: "Your providers",
        userProvidersBody: "Add your own charging providers with custom names and prices.",
  ...
  be: {
    ...
    settings: {
      ...
      providerTariffs: {
        title: "Тарыфы правайдараў",
        body: "Рэдагуйце цэны AC/DC для кожнага правайдара — сесіі ў захаванай лакацыі аўтаматычна тарыфікуюцца па гэтых цэнах.",
        acLabel: "AC",
        dcLabel: "DC",
        save: "Захаваць тарыфы правайдараў",
        saved: "Тарыфы правайдараў захаваны",
        resetDone: "Скінута да прадвызначанай цаны",
        invalidPrice: "Цэны павінны быць нулявымі або дадатнымі",
        userProvidersTitle: "Вашы правайдары",
        userProvidersBody: "Дадавайце ўласных правайдараў з індывідуальнымі назвамі і цэнамі.",
  ...
  ru: {
    ...
    settings: {
      ...
      providerTariffs: {
        title: "Тарифы провайдеров",
        body: "Редактируйте цены AC/DC для каждого провайдера — сессии в сохранённой локации автоматически тарифицируются по этим ценам.",
        acLabel: "AC",
        dcLabel: "DC",
        save: "Сохранить тарифы провайдеров",
        saved: "Тарифы провайдеров сохранены",
        resetDone: "Сброшено до цены по умолчанию",
        invalidPrice: "Цены должны быть неотрицательными",
        userProvidersTitle: "Ваши провайдеры",
        userProvidersBody: "Добавляйте собственных провайдеров с произвольными названиями и ценами.",
