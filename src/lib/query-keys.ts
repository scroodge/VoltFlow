export const queryKeys = {
  ...
  voltflowMateTripMonthDates: (
    year: number,
    month: number,
    vehicleId: string | null,
  ) => ["bydmate-trip-month-dates", year, month, vehicleId] as const,
  voltflowMateTripSamples: (tripId: string) =>
    ["bydmate-trip-samples", tripId] as const,
  ...
  voltflowMateTripTrack: (tripId: string) =>
    ["bydmate-trip-track", tripId] as const,
  voltflowMateTelemetryHistory: (
    range: string,
    date: string,
    vehicleId: string | null,
  ) => ["bydmate-telemetry-history", range, date, vehicleId] as const,
  voltflowMateSohHistory: (
    range: string,
    date: string,
    vehicleId: string | null,
  ) => ["bydmate-soh-history", range, date, vehicleId] as const,
  voltflowMateAuxVoltageHistory: (
    vehicleId: string,
    from: string,
    to: string,
  ) => ["bydmate-aux-voltage-history", vehicleId, from, to] as const,
  vehicleCommands: (vehicleId: string | null) =>
    ["vehicle-commands", vehicleId] as const,
