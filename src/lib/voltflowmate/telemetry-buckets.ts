...
export function consumptionByOutsideTemp(trips: VoltflowMateTripRow[]): TempConsumptionBucket[] {
  ...
  for (const trip of trips) {
    ...
    const temp = (trip as VoltflowMateTripRow & { outside_temp_avg?: number | null }).outside_temp_avg;
