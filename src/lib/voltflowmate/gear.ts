...
type GearSnapshot = Pick<VoltflowMateLiveSnapshotRow, "telemetry" | "diplus" | "diplus_gear">;
...
export function readGear(snapshot: GearSnapshot | VoltflowMateTelemetryPointRow | null | undefined) {
