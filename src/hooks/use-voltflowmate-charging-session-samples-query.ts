...
import type { VoltflowMateDiplus, VoltflowMateTelemetry, SessionStatus } from "@/types/database";
...
export function useVoltflowMateChargingSessionSamplesQuery(
  sessionId: string,
  vehicleId?: string | null,
  ...
  return useQuery({
    queryKey: queryKeys.voltflowMateChargingSessionSamples(sessionId, vehicleKey),
